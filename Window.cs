...
namespace Grafkom1
{
    ...
    {
        Asset3D LightObjectNicho1 = new Asset3D(new Vector3(1, 1, 1));
        Asset3D LightObjectNicho2 = new Asset3D(new Vector3(1, 1, 1));
        //badan
        Asset3D LightObjectNicho3 = new Asset3D(new Vector3(1, 1, 1));
        //kaki tangan
        Asset3D LightObjectNicho4 = new Asset3D(new Vector3(1, 1, 1));

        //badan pesawat
        Asset3D LightObjectSutan = new Asset3D(new Vector3(1, 1, 1));

        //badan roket
        Asset3D LightObjectKenneth = new Asset3D(new Vector3(1, 1, 1));

        //jendela roket
        Asset3D LightObjectJendelaRoket = new Asset3D(new Vector3(1, 1, 1));
        ...
        Asset2D shirt = new Asset2D(new float[1080], new uint[]
      {
       ...
       }, new uint[]
       {
        ...
        protected override void OnLoad()
        {
            ...
            LightObjectNicho1.createBoxVertices(0.75f, 2.3f, 0, 0.5f, 0.5f, 0.5f);
            LightObjectNicho1.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);

            LightObjectNicho2.createBoxVertices(-0.75f, 1f, 0, 0.5f, 0.5f, 0.5f);
            LightObjectNicho2.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);

            LightObjectNicho3.createBoxVertices(0.5f, -0.2f, 0.3f, 0.5f, 0.5f, 0.5f);
            LightObjectNicho3.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);

            LightObjectNicho4.createBoxVertices(1.75f, -0.3f, 0, 0.5f, 0.5f, 0.5f);
            LightObjectNicho4.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);
            ...
            if (isThirdPerson)
            {
                var _cameraPosInit = new Vector3(0, 0.5f, (float)_object3dNicho[1]._centerPosition.Z - 1.25f);
                _camera = new Camera(_cameraPosInit, Size.X / (float)Size.Y);
                _camera.Yaw += 180f;
            }
            else
            {
                var _cameraPosInit = new Vector3(0, 1, 3);
                _camera = new Camera(_cameraPosInit, Size.X / (float)Size.Y);
            }
            ...
            //sepatu kanan, temp0
            _object3dNicho[13] = new Asset3D(new Vector3(1f, 1f, 0));
            _object3dNicho[13].createEllipticParaboloid(0.125f, 0.125f, 0.125f, 1.25f, 0.025f, 0.2f);
            //sepatu kiri, temp02
            _object3dNicho[14] = new Asset3D(new Vector3(1f, 1f, 0));
            ...
            _object3dNicho[1].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);
           
            _object3dNicho[3].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);

            _object3dNicho[13].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);
            _object3dNicho[14].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);
            for (int i = 0; i < 19; i++)
            {
            ...
            LightObjectKenneth.createBoxVertices(9.75f, 2f, 5, 0.5f, 0.5f, 0.5f);
            LightObjectKenneth.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);

            LightObjectJendelaRoket.createBoxVertices(8.75f, 1.5f, 1, 0.5f, 0.5f, 0.5f);
            LightObjectJendelaRoket.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);
            ...
            //jendela bulat
            _object3dKenneth[2] = new Asset3D(new Vector3(0.0f, 1.0f, 1.0f));
            ...
            _object3dKenneth[0].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);
            _object3dKenneth[2].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);
            ...
            _object3dSutan[1].load_withnormal(Constants.path + "newobject.vert", Constants.path + "newobject.frag", Size.X, Size.Y);
            
            LightObjectSutan.createBoxVertices(5.75f, 12f, 0, 0.5f, 0.5f, 0.5f);
            LightObjectSutan.load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size.X, Size.Y);
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            _object3dNicho[3].setFragVariable(_object3dNicho[3]._color, new Vector3(1, 1, 1));
            _object3dNicho[3].setSpecularDiffuseVariable(LightObjectNicho4._centerPosition, _camera.Position);
            ...
            _object3dNicho[1].setFragVariable(_object3dNicho[1]._color, new Vector3(1, 1, 1));
            if (isLO == false)
            {

                _object3dNicho[1].setSpecularDiffuseVariable(LightObjectNicho1._centerPosition, _camera.Position);
            }
            ...
            _object3dNicho[14].setFragVariable(_object3dNicho[14]._color, new Vector3(1, 1, 1));
            _object3dNicho[14].setSpecularDiffuseVariable(LightObjectNicho3._centerPosition, _camera.Position);

            _object3dNicho[13].render(3, _time3, temp0, _camera.GetViewMatrix(), _camera.GetProjectionMatrix());
            _object3dNicho[13].setFragVariable(_object3dNicho[13]._color, new Vector3(1, 1, 1));
            _object3dNicho[13].setSpecularDiffuseVariable(LightObjectNicho3._centerPosition, _camera.Position);
            ...
            _object3dKenneth[0].setFragVariable(_object3dKenneth[0]._color, new Vector3(1, 1, 1));
            _object3dKenneth[0].setSpecularDiffuseVariable(LightObjectKenneth._centerPosition, _camera.Position);

            _object3dKenneth[2].setFragVariable(_object3dKenneth[2]._color, new Vector3(1, 0, 1));
            _object3dKenneth[2].setSpecularDiffuseVariable(LightObjectJendelaRoket._centerPosition, _camera.Position);
            LightObjectJendelaRoket.render(3, _time, temp19, _camera.GetViewMatrix(), _camera.GetProjectionMatrix());
            ...
            _object3dSutan[1].setFragVariable(_object3dSutan[1]._color, new Vector3(1, 1, 1));
            _object3dSutan[1].setSpecularDiffuseVariable(LightObjectSutan._centerPosition, _camera.Position);
        ...
        //cek collision kamera dan object
        public bool collision(Asset3D obj, Vector3 camPos)
        {
            bool collisionZ = obj._centerPosition.Z + obj.radZ >= camPos.Z;
            bool collisionY = obj._centerPosition.Y + obj.radY >= camPos.Y;

            bool collisionX = obj._centerPosition.X + obj.radX >= camPos.X;
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            //mengganti mode kamera dari FPV ke TPV dan sebaliknya
            ...
            if (KeyboardState.IsKeyDown(Keys.Tab))
            {
                ...
                else if (isLO == true)
                {
                    ...
                    _object3dNicho[1].setSpecularDiffuseVariable(LightObjectNicho2._centerPosition, _camera.Position);
                    isLO = false;
                }

            }
            //mengganti warna langit
            ...
            {
                if (!isThirdPerson && !collision(_object3dNicho[6], _camera.Position) && !collision(_object3dKenneth[0], _camera.Position) && !collision(_object3dSutan[1], _camera.Position) && !collision(_object3dNicho[1], _camera.Position))
                {
            ...
            {
                if (!isThirdPerson && !collision(_object3dNicho[6], _camera.Position - (_camera.Right * cameraSpeed * (float)args.Time)) && !collision(_object3dKenneth[0], _camera.Position - (_camera.Right * cameraSpeed * (float)args.Time)) && !collision(_object3dSutan[1], _camera.Position - (_camera.Right * cameraSpeed * (float)args.Time)) && !collision(_object3dNicho[1], _camera.Position - (_camera.Right * cameraSpeed * (float)args.Time)))
                {
                    _camera.Position -= _camera.Right * cameraSpeed * (float)args.Time;
                }
            }
            //memutar kamera
            if (key.IsKeyReleased(Keys.J))
            {
                _camera.Yaw += 180f;
            }
            if (key.IsKeyReleased(Keys.O))
            {
                _camera.Yaw += 90f;
            }
            if (key.IsKeyReleased(Keys.H))
            {
                _camera.Pitch += 180f;
            }
            if (key.IsKeyReleased(Keys.G))
            {
                _camera.Pitch += 90f;
            }
            ...
            //mengatur scaling object matahari dan bulan
        ...
        //pergerakan kaki saat berjalan mundur
